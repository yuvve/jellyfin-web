...
function createSections(instance, elem, apiClient) {
    ...
    for (const section of sections) {
        ...
        html += '</div>';
        html += '<div is="emby-scroller" class="padded-top-focusscale padded-bottom-focusscale" data-centerfocus="true"><div is="emby-itemscontainer" class="itemsContainer scrollSlider focuscontainer-x" data-monitor="markWatchlist"></div></div>';
        html += '</div>';
    }
